<?php
/**
 * Fallback-лендинг: показывается, пока на главной не собран билдер (sections).
 * Это исходная статичная вёрстка. Когда импортируешь JSON и заполнишь блоки —
 * front-page.php начнёт рендерить из flexible content, а этот файл не вызывается.
 *
 * @package StudioDark
 */
?>
